...
const Footer = () => {
  return (
    // <div className="m-4 pt-8 text-primary">
    //   <div className="grid md:grid-cols-2">
    //     <div className="flex justify-between w-full md:max-w-[300px]">
    ...
    // </div>
    <div className="bg-primary mx-8 pt-8  text-primary">
      <div className="flex justify-between w-full border-t ">
        ...
        <div>
          <div className="flex py-4 justify-between text-accent space-x-5">
            <FaTwitter />
            <FaFacebook />
            <FaGithub />
            <FaLinkedin />
